...
test('DT Baccarat Small Dragon Flow', async ({ page }) => {
  ...
  const testCases = [
    ...
    { result: '5', resultBanker: '5', resultPlayer: '7' },
     ...
     // small dragon banker pair
    { result: '54', resultBanker: '0', resultPlayer: '7' },
    { result: '54', resultBanker: '1', resultPlayer: '7' },
    { result: '54', resultBanker: '2', resultPlayer: '7' },
    { result: '54', resultBanker: '3', resultPlayer: '7' },
    { result: '54', resultBanker: '4', resultPlayer: '7' },
    { result: '54', resultBanker: '5', resultPlayer: '7' },

     // small dragon player pair
    { result: '56', resultBanker: '0', resultPlayer: '7' },
    { result: '56', resultBanker: '1', resultPlayer: '7' },
    { result: '56', resultBanker: '2', resultPlayer: '7' },
    { result: '56', resultBanker: '3', resultPlayer: '7' },
    { result: '56', resultBanker: '4', resultPlayer: '7' },
    { result: '56', resultBanker: '5', resultPlayer: '7' },

     // small dragon banker, player pair
    { result: '546', resultBanker: '0', resultPlayer: '7' },
    { result: '546', resultBanker: '1', resultPlayer: '7' },
    { result: '546', resultBanker: '2', resultPlayer: '7' },
    { result: '546', resultBanker: '3', resultPlayer: '7' },
    { result: '546', resultBanker: '4', resultPlayer: '7' },
    { result: '546', resultBanker: '5', resultPlayer: '7' },
