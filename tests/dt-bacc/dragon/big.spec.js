...
test('DT Baccarat Big Dragon Flow', async ({ page }) => {
  ...
  const testCases = [
    ...
    // big dragon banker pair
    { result: '94', resultBanker: '0', resultPlayer: '7' },
    { result: '94', resultBanker: '1', resultPlayer: '7' },
    { result: '94', resultBanker: '2', resultPlayer: '7' },
    { result: '94', resultBanker: '3', resultPlayer: '7' },
    { result: '94', resultBanker: '4', resultPlayer: '7' },
    { result: '94', resultBanker: '5', resultPlayer: '7' },


    // big dragon player pair
    { result: '96', resultBanker: '0', resultPlayer: '7' },
    { result: '96', resultBanker: '1', resultPlayer: '7' },
    { result: '96', resultBanker: '2', resultPlayer: '7' },
    { result: '96', resultBanker: '3', resultPlayer: '7' },
    { result: '96', resultBanker: '4', resultPlayer: '7' },
    { result: '96', resultBanker: '5', resultPlayer: '7' },


    // big dragon banker, player pair
    { result: '946', resultBanker: '0', resultPlayer: '7' },
    { result: '946', resultBanker: '1', resultPlayer: '7' },
    { result: '946', resultBanker: '2', resultPlayer: '7' },
    { result: '946', resultBanker: '3', resultPlayer: '7' },
    { result: '946', resultBanker: '4', resultPlayer: '7' },
    { result: '946', resultBanker: '5', resultPlayer: '7' },
