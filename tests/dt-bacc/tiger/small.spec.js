...
test('DT Baccarat Small Tiger Flow', async ({ page }) => {
  ...
  const testCases = [
    ...
    //Small tiger Banker pair
    { result: '04', resultBanker: '6', resultPlayer: '0' },
    { result: '04', resultBanker: '6', resultPlayer: '1' },
    { result: '04', resultBanker: '6', resultPlayer: '2' },
    { result: '04', resultBanker: '6', resultPlayer: '3' },
    { result: '04', resultBanker: '6', resultPlayer: '4' },
    { result: '04', resultBanker: '6', resultPlayer: '5' },

    //Small tiger player pair
    { result: '06', resultBanker: '6', resultPlayer: '0' },
    { result: '06', resultBanker: '6', resultPlayer: '1' },
    { result: '06', resultBanker: '6', resultPlayer: '2' },
    { result: '06', resultBanker: '6', resultPlayer: '3' },
    { result: '06', resultBanker: '6', resultPlayer: '4' },
    { result: '06', resultBanker: '6', resultPlayer: '5' },

    //Small tiger banker,player pair
    { result: '046', resultBanker: '6', resultPlayer: '0' },
    { result: '046', resultBanker: '6', resultPlayer: '1' },
    { result: '046', resultBanker: '6', resultPlayer: '2' },
    { result: '046', resultBanker: '6', resultPlayer: '3' },
    { result: '046', resultBanker: '6', resultPlayer: '4' },
    { result: '046', resultBanker: '6', resultPlayer: '5' },
  ];
