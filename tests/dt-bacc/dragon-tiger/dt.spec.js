...
test('DT Baccarat Dragon Tiger Flow', async ({ page }) => {
  ...
  const testCases = [
    ...
    { result: '99', resultBanker: '6', resultPlayer: '7' },
     ...
     // Dragon tiger banker pair
    { result: '994', resultBanker: '6', resultPlayer: '7' },

     // Dragon tiger player pair
    { result: '996', resultBanker: '6', resultPlayer: '7' },

     // Dragon tiger banker,player pair
    { result: '9946', resultBanker: '6', resultPlayer: '7' },
